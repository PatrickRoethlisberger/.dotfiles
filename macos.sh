...
###############################################################################
# General MacOS Setup                                                         #
# by https://github.com/mathiasbynens/dotfiles/blob/master/.macos             #
###############################################################################
...
defaults write NSGlobalDomain AppleLanguages -array "en-CH" "en" "de"
...
# Top right screen corner with modifier → Start screen saver
